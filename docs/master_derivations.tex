...
%% ════════════════════════════════════════════════════════════════════════════
\section{The \texorpdfstring{$\Theta(\sqrt{n})$}{Theta(sqrt(n))} Coherent Search}
\label{sec:sqrt-n}
%% ════════════════════════════════════════════════════════════════════════════
...
\begin{corollary}[Speedup over brute-force]\label{cor:speedup}
  The coherent speedup over brute-force ($\approx n/2$ evaluations) is
  \begin{equation}
...
\begin{enumerate}
  ...
  \item The Dirichlet kernel on $T^2$ gives $\Theta(\sqrt{n})$ search
