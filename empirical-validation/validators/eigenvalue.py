...
This module validates:
  1. |μ|² = 1  (unit modulus)
  2. μ⁸ = 1   (8th-order periodicity)
  3. Re(μ) = −1/√2, Im(μ) = 1/√2  (component values)
  4. μ + μ* = −√2  (sum with conjugate = −√2, Ohm–Coherence trace)
  5. μ · μ* = 1  (product with conjugate = 1)

using both SymPy (symbolic exact verification) and NumPy (numerical
